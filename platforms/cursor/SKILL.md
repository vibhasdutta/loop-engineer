...
Copy the 5 pre-built agent files from `~/.cursor/skills/loop-engineer/agents/` into `.cursor/agents/`:
- `tool-scout.md`
- `developer.md`
- `qa-tester.md`
- `auditor.md`
...
> .cursor/agents/ ready: tool-scout · developer · qa-tester · verifier · auditor · memory-keeper
> Starting loop..."
...
Follow .cursor/agents/qa-tester.md.
```
...
Distill learnings. Follow .cursor/agents/memory-keeper.md.
```
