...
Copy the 5 pre-built agent files from `~/.gemini/skills/loop-engineer/agents/` into `.agents/`:
- `tool-scout.md`
- `developer.md`
- `qa-tester.md`
- `auditor.md`
...
> .agents/ ready: tool-scout · developer · qa-tester · verifier · auditor · memory-keeper
> Starting loop..."
...
Dispatch a developer subagent with the following goal. Wait for it to complete and write TOOLS.md before continuing.
The subagent should read `.agents/tool-scout.md` for its role definition.
```
...
Distill learnings. Follow .agents/memory-keeper.md.
```
